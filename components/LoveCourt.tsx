...
const CASES: Case[] = [
  {
    ...
    charge:
      "المتهمة (ندا) بتقول 'أنا جاهزة وفاضلي 5 دقايق بس' بينما هي لسه بتختار الطقم أمام المراية!",
    evidence:
  ...
  },
  {
    ...
    charge:
      "المتهم (محمد) بنام فجأة في نص الكلام وأسيب الشات شغال بينما (ندا) صاحية ومستنية أرد!",
    evidence:
